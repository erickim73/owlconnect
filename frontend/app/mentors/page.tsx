        ...
        <div className="space-y-8">
            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-gray-100 via-gray-100 to-gray-200 rounded-3xl p-8 border border-gray-200/50 group">
              ...
              <div className="relative">
                <div className="flex items-center space-x-2 mb-4">
                  <div className="text-sm text-gray-600 animate-pulse">Career Explorer</div>
                ...
                <p className="text-gray-600 text-lg max-w-3xl animate-fade-in-delay mb-8">
                  Based on your resume and experiences, we&apos;ll show you three potential career trajectories that align with your goals and skills.
                </p>
              </div>
            </div>
          )}
          ...
          {!showResults && (
            <Card className="bg-gradient-to-br from-gray-100 to-gray-200 border-gray-300/50 rounded-3xl overflow-hidden hover:shadow-2xl hover:shadow-gray-100/50 transition-all duration-500">
              <CardHeader>
                <CardTitle className="text-gray-900 text-2xl font-bold flex items-center">
                  <Sparkles className="w-6 h-6 mr-3 text-blue-600" />
                  What&apos;s your career goal?
                </CardTitle>
                <CardDescription className="text-gray-600 text-base">
                  Describe your ideal career path, interests, or what you want to achieve professionally.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <Textarea
                  placeholder="e.g., I want to become a software engineer at a tech startup, focusing on building user-friendly applications that solve real-world problems. I'm interested in full-stack development and have experience with JavaScript and Python..."
                  value={careerGoal}
                  onChange={(e) => setCareerGoal(e.target.value)}
                  className="min-h-32 bg-white/50 backdrop-blur-sm border-gray-300/50 text-gray-900 placeholder-gray-400 focus:border-blue-500/50 focus:bg-white/80 transition-all duration-300 rounded-2xl resize-none"
                />
                <div className="flex justify-end">
                  <Button
                    onClick={handleSubmit}
                    disabled={!careerGoal.trim() || isLoading}
                    className="bg-gradient-to-r from-blue-600 to-purple-600 text-white hover:from-blue-700 hover:to-purple-700 rounded-full px-8 py-3 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/20 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isLoading ? (
                      <>
          ...
          {isLoading && (
            <div className="fixed inset-0 bg-white/95 backdrop-blur-sm z-50 flex flex-col items-center justify-center space-y-8">
              <div className="relative">
              ...
              <div className="text-center space-y-4 max-w-md">
                ...
                <p className="text-gray-600 text-lg">Matching your experiences with potential career paths...</p>
              </div>
